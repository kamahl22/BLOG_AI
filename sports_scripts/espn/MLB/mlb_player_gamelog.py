...
player_name = "Seiya_Suzuki"  # Define player_name explicitly
season = 2025
team_id = '16'  # Cubs team ID
team_name = "Cubs"
BASE_DIR = f"/Users/kamahl/BLOG_AI/espn/mlb/{team_name}/{player_name}"
output_file = os.path.join(BASE_DIR, f"{player_name}_gamelog.csv")  # Changed to .csv for clarity
debug_file = os.path.join(BASE_DIR, f"debug_player_{player_id}_{season}.json")
...
if response.status_code == 200:
    ...
    with open(os.path.join(BASE_DIR, f"raw_response_{player_id}_{season}.json"), 'w') as f:
