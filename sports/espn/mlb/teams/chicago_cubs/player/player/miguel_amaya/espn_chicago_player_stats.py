...
def fetch_player_stats():
    ...
    if response.status_code != 200:
        print(f"Error fetching stats for Miguel Amaya: {response.status_code}")
        return
    ...
    if not tables:
        ...
        return
    with open(os.path.join("/Users/kamahl/BLOG_AI/database/espn/mlb/teams/chicago_cubs/player/player/miguel_amaya", "miguel_amaya_stats.csv"), "w", newline="") as f:
        writer = csv.writer(f)
    ...
    print(f"Saved stats for Miguel Amaya")
