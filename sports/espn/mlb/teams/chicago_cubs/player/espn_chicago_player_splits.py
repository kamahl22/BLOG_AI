...
def scrape_cubs_player_splits():
    print("📡 Fetching Chicago Cubs player splits...")
            ...
            for section in sections:
                ...
                if table:
                    ...
                    if rows:
                        ...
                        # client.table("player_splits").insert([{"team": "chicago-cubs", "player": player['name'], "split": section_name, **dict(zip(headers, row))} for row in rows]).execute()
                    else:
...
if __name__ == "__main__":
    splits = scrape_cubs_player_splits()
