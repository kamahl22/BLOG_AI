...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/28963/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Clayton Kershaw (ID: 28963): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"clayton_kershaw_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nClayton Kershaw 2025 Splits Data:")
