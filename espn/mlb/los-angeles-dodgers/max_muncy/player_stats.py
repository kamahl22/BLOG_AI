...
player_name_slug = "max-muncy"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/33303/max-muncy"
...
try:
    ...
    print(f"Error fetching stats for Max Muncy (ID: 33303): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Max Muncy")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Max Muncy")
    exit(1)
...
output_file = os.path.join(output_dir, f"max_muncy_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
