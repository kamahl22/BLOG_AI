...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/30791/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Miguel Rojas (ID: 30791): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"miguel_rojas_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
