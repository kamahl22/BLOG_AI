...
player_name_slug = "pete-crow-armstrong"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/4717833/pete-crow-armstrong"
...
try:
    ...
    print(f"Error fetching stats for Pete Crow-Armstrong (ID: 4717833): {e}")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Pete Crow-Armstrong")
    exit(1)
...
output_file = os.path.join(output_dir, f"pete_crow-armstrong_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nPete Crow-Armstrong 2025 Stats Data:")
