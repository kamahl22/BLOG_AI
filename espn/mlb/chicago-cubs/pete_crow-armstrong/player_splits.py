...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4717833/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Pete Crow-Armstrong (ID: 4717833): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"pete_crow-armstrong_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nPete Crow-Armstrong 2025 Splits Data:")
