...
player_name_slug = "ian-happ"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/34945/ian-happ"
...
try:
    ...
    print(f"Error fetching stats for Ian Happ (ID: 34945): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Ian Happ")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Ian Happ")
    exit(1)
...
output_file = os.path.join(output_dir, f"ian_happ_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
