...
player_name_slug = "ryan-pressly"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/33072/ryan-pressly"
...
try:
    ...
    print(f"Error fetching stats for Ryan Pressly (ID: 33072): {e}")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Ryan Pressly")
    exit(1)
...
output_file = os.path.join(output_dir, f"ryan_pressly_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
