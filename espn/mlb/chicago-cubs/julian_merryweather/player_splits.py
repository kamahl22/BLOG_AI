...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39816/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Julian Merryweather (ID: 39816): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"julian_merryweather_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJulian Merryweather 2025 Splits Data:")
