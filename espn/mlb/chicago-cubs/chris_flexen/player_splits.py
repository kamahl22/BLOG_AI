...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36067/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Chris Flexen (ID: 36067): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"chris_flexen_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
