...
player_name_slug = "colin-rea"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/33950/colin-rea"
...
try:
    ...
    print(f"Error fetching stats for Colin Rea (ID: 33950): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Colin Rea")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Colin Rea")
    exit(1)
...
output_file = os.path.join(output_dir, f"colin_rea_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
