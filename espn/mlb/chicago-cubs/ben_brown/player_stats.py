...
player_name_slug = "ben-brown"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/41516/ben-brown"
...
try:
    ...
    print(f"Error fetching stats for Ben Brown (ID: 41516): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Ben Brown")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Ben Brown")
    exit(1)
...
output_file = os.path.join(output_dir, f"ben_brown_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
