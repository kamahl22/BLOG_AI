...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33572/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Isiah Kiner-Falefa (ID: 33572): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"isiah_kiner-falefa_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nIsiah Kiner-Falefa 2025 Splits Data:")
