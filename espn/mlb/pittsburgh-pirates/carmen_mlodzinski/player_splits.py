...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4298378/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Carmen Mlodzinski (ID: 4298378): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"carmen_mlodzinski_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nCarmen Mlodzinski 2025 Splits Data:")
