...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39801/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Dennis Santana (ID: 39801): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"dennis_santana_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDennis Santana 2025 Splits Data:")
