...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35020/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Ke'Bryan Hayes (ID: 35020): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"kebryan_hayes_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nKe'Bryan Hayes 2025 Splits Data:")
