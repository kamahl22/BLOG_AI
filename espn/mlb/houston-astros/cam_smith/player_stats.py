...
player_name_slug = "cam-smith"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/5080766/cam-smith"
...
try:
    ...
    print(f"Error fetching stats for Cam Smith (ID: 5080766): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Cam Smith")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Cam Smith")
    exit(1)
...
output_file = os.path.join(output_dir, f"cam_smith_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
