...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32764/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"lance_mccullers_jr_gamelog.csv")
if csv_data:
