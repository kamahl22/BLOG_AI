...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39706/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Isaac Paredes (ID: 39706): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"isaac_paredes_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nIsaac Paredes 2025 Splits Data:")
