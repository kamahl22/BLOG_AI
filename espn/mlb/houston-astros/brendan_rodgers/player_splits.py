...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35073/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Brendan Rodgers (ID: 35073): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"brendan_rodgers_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nBrendan Rodgers 2025 Splits Data:")
