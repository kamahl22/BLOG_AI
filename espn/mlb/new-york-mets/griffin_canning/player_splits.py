...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41065/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Griffin Canning (ID: 41065): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"griffin_canning_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nGriffin Canning 2025 Splits Data:")
