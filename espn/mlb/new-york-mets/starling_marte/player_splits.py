...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/30830/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Starling Marte (ID: 30830): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"starling_marte_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nStarling Marte 2025 Splits Data:")
