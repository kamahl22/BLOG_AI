...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32159/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Brandon Nimmo (ID: 32159): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"brandon_nimmo_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nBrandon Nimmo 2025 Splits Data:")
