...
player_name_slug = "brett-baty"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/42414/brett-baty"
...
try:
    ...
    print(f"Error fetching stats for Brett Baty (ID: 42414): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Brett Baty")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Brett Baty")
    exit(1)
...
output_file = os.path.join(output_dir, f"brett_baty_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
