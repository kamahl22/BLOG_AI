...
player_name_slug = "edwin-diaz"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/35394/edwin-diaz"
...
try:
    ...
    print(f"Error fetching stats for Edwin Diaz (ID: 35394): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Edwin Diaz")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Edwin Diaz")
    exit(1)
...
output_file = os.path.join(output_dir, f"edwin_diaz_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
