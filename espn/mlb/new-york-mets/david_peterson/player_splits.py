...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40921/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for David Peterson (ID: 40921): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"david_peterson_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDavid Peterson 2025 Splits Data:")
