...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36618/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Lucas Erceg (ID: 36618): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"lucas_erceg_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
