...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35277/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Taylor Clarke (ID: 35277): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"taylor_clarke_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTaylor Clarke 2025 Splits Data:")
