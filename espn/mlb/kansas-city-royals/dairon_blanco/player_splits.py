...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42228/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Dairon Blanco (ID: 42228): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"dairon_blanco_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDairon Blanco 2025 Splits Data:")
