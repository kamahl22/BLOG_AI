...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/3994084/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Evan Sisk (ID: 3994084): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"evan_sisk_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
