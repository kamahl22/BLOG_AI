...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41344/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Jonathan Bowlan (ID: 41344): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"jonathan_bowlan_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJonathan Bowlan 2025 Splits Data:")
