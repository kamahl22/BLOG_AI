...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39949/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for John Schreiber (ID: 39949): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"john_schreiber_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJohn Schreiber 2025 Splits Data:")
