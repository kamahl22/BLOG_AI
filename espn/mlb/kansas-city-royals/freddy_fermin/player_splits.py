...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41928/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Freddy Fermin (ID: 41928): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"freddy_fermin_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nFreddy Fermin 2025 Splits Data:")
