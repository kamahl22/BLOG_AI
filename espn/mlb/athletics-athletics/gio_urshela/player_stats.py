...
# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/32721/gio-urshela"
...
try:
    ...
    print(f"Error fetching stats for Gio Urshela (ID: 32721): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Gio Urshela")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Gio Urshela")
    exit(1)
...
output_file = os.path.join(output_dir, f"gio_urshela_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
