...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41743/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Emmanuel Clase (ID: 41743): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"emmanuel_clase_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nEmmanuel Clase 2025 Splits Data:")
