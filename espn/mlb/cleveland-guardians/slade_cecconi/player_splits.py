...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41462/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Slade Cecconi (ID: 41462): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"slade_cecconi_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSlade Cecconi 2025 Splits Data:")
