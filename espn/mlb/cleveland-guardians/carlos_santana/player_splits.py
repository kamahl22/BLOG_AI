...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/30280/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Carlos Santana (ID: 30280): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"carlos_santana_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nCarlos Santana 2025 Splits Data:")
