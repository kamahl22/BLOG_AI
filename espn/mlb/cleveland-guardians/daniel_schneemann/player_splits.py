...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42001/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Daniel Schneemann (ID: 42001): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"daniel_schneemann_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDaniel Schneemann 2025 Splits Data:")
