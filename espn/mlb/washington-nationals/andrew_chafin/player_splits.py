...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32810/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Andrew Chafin (ID: 32810): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"andrew_chafin_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAndrew Chafin 2025 Splits Data:")
