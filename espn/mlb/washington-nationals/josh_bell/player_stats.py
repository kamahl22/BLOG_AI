...
player_name_slug = "josh-bell"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/32517/josh-bell"
...
try:
    ...
    print(f"Error fetching stats for Josh Bell (ID: 32517): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Josh Bell")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Josh Bell")
    exit(1)
...
output_file = os.path.join(output_dir, f"josh_bell_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
