...
player_name_slug = "cj-abrams"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/42402/cj-abrams"
...
try:
    ...
    print(f"Error fetching stats for CJ Abrams (ID: 42402): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for CJ Abrams")
    exit(1)
...
if df.empty:
    print(f"No stats data found for CJ Abrams")
    exit(1)
...
output_file = os.path.join(output_dir, f"cj_abrams_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
