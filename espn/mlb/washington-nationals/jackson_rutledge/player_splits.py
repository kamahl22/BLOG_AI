...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42434/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Jackson Rutledge (ID: 42434): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"jackson_rutledge_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJackson Rutledge 2025 Splits Data:")
