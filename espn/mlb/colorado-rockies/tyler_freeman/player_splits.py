...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40958/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Tyler Freeman (ID: 40958): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"tyler_freeman_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTyler Freeman 2025 Splits Data:")
