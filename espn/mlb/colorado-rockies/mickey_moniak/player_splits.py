...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36181/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Mickey Moniak (ID: 36181): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"mickey_moniak_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nMickey Moniak 2025 Splits Data:")
