...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/34874/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for German Marquez (ID: 34874): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"german_marquez_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nGerman Marquez 2025 Splits Data:")
