...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42178/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Adley Rutschman (ID: 42178): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"adley_rutschman_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAdley Rutschman 2025 Splits Data:")
