...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42178/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"adley_rutschman_gamelog.csv")
if csv_data:
