...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40519/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Emmanuel Rivera (ID: 40519): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"emmanuel_rivera_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nEmmanuel Rivera 2025 Splits Data:")
