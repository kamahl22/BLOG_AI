...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/37793/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Seranthony Dominguez (ID: 37793): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"seranthony_dominguez_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSeranthony Dominguez 2025 Splits Data:")
