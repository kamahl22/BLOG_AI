...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35536/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Yennier Cano (ID: 35536): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"yennier_cano_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
