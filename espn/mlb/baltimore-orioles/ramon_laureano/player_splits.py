...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35142/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Ramon Laureano (ID: 35142): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"ramon_laureano_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nRamon Laureano 2025 Splits Data:")
