...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/29155/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Charlie Morton (ID: 29155): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"charlie_morton_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nCharlie Morton 2025 Splits Data:")
