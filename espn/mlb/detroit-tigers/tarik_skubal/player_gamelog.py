...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42409/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"tarik_skubal_gamelog.csv")
if csv_data:
