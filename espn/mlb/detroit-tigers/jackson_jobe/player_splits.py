...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4872647/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Jackson Jobe (ID: 4872647): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"jackson_jobe_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
