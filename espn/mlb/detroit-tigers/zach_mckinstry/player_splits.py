...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/38420/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Zach McKinstry (ID: 38420): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"zach_mckinstry_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nZach McKinstry 2025 Splits Data:")
