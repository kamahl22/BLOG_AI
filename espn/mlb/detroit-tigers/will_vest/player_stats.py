...
player_name_slug = "will-vest"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/41606/will-vest"
...
try:
    ...
    print(f"Error fetching stats for Will Vest (ID: 41606): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Will Vest")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Will Vest")
    exit(1)
...
output_file = os.path.join(output_dir, f"will_vest_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
