...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/3896017/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Sean Guenther (ID: 3896017): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"sean_guenther_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSean Guenther 2025 Splits Data:")
