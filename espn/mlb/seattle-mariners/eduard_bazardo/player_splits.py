...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41939/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Eduard Bazardo (ID: 41939): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"eduard_bazardo_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nEduard Bazardo 2025 Splits Data:")
