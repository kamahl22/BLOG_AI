...
player_name_slug = "bryan-woo"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/4629089/bryan-woo"
...
try:
    ...
    print(f"Error fetching stats for Bryan Woo (ID: 4629089): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Bryan Woo")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Bryan Woo")
    exit(1)
...
output_file = os.path.join(output_dir, f"bryan_woo_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
