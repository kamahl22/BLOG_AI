...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32525/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Jorge Polanco (ID: 32525): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"jorge_polanco_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJorge Polanco 2025 Splits Data:")
