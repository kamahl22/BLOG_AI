...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41292/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Cal Raleigh (ID: 41292): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"cal_raleigh_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
