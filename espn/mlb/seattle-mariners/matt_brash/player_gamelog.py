...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4894467/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"matt_brash_gamelog.csv")
if csv_data:
