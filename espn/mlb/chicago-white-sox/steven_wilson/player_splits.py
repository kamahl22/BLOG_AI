...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41828/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Steven Wilson (ID: 41828): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"steven_wilson_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSteven Wilson 2025 Splits Data:")
