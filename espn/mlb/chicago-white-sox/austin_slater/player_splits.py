...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35265/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Austin Slater (ID: 35265): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"austin_slater_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAustin Slater 2025 Splits Data:")
