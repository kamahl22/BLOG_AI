...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42823/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"davis_martin_gamelog.csv")
if csv_data:
