...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4623366/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Jared Shuster (ID: 4623366): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"jared_shuster_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJared Shuster 2025 Splits Data:")
