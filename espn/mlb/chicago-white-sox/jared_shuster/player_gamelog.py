...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4623366/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"jared_shuster_gamelog.csv")
if csv_data:
