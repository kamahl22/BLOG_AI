...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32157/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Adrian Houser (ID: 32157): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"adrian_houser_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAdrian Houser 2025 Splits Data:")
