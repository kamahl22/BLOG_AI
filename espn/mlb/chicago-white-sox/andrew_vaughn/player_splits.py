...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42394/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Andrew Vaughn (ID: 42394): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"andrew_vaughn_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAndrew Vaughn 2025 Splits Data:")
