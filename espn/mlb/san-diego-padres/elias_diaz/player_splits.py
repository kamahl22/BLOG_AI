...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33594/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Elias Diaz (ID: 33594): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"elias_diaz_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
