...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36036/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Wandy Peralta (ID: 36036): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"wandy_peralta_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nWandy Peralta 2025 Splits Data:")
