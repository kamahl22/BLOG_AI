...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40917/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Adrian Morejon (ID: 40917): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"adrian_morejon_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAdrian Morejon 2025 Splits Data:")
