...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/31606/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Xander Bogaerts (ID: 31606): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"xander_bogaerts_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nXander Bogaerts 2025 Splits Data:")
