...
player_name_slug = "jo-adell"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/40854/jo-adell"
...
try:
    ...
    print(f"Error fetching stats for Jo Adell (ID: 40854): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Jo Adell")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Jo Adell")
    exit(1)
...
output_file = os.path.join(output_dir, f"jo_adell_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
