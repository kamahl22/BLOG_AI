...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41515/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Connor Brogdon (ID: 41515): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"connor_brogdon_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nConnor Brogdon 2025 Splits Data:")
