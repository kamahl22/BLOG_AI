...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/29951/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Travis d'Arnaud (ID: 29951): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"travis_darnaud_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTravis d'Arnaud 2025 Splits Data:")
