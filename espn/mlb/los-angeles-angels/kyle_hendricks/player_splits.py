...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33173/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Kyle Hendricks (ID: 33173): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"kyle_hendricks_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nKyle Hendricks 2025 Splits Data:")
