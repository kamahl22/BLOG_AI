...
player_name_slug = "josh-lowe"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/40557/josh-lowe"
...
try:
    ...
    print(f"Error fetching stats for Josh Lowe (ID: 40557): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Josh Lowe")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Josh Lowe")
    exit(1)
...
output_file = os.path.join(output_dir, f"josh_lowe_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
