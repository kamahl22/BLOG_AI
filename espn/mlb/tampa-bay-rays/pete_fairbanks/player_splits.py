...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42180/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Pete Fairbanks (ID: 42180): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"pete_fairbanks_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nPete Fairbanks 2025 Splits Data:")
