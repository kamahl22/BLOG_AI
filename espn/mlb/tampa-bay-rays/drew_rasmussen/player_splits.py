...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42584/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Drew Rasmussen (ID: 42584): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"drew_rasmussen_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDrew Rasmussen 2025 Splits Data:")
