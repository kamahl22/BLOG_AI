...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40810/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Jonathan Aranda (ID: 40810): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"jonathan_aranda_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJonathan Aranda 2025 Splits Data:")
