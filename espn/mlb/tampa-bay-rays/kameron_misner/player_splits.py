...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42416/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Kameron Misner (ID: 42416): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"kameron_misner_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nKameron Misner 2025 Splits Data:")
