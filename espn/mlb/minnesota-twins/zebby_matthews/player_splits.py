...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4791597/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Zebby Matthews (ID: 4791597): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"zebby_matthews_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nZebby Matthews 2025 Splits Data:")
