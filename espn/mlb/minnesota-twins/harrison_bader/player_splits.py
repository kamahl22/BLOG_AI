...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35062/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Harrison Bader (ID: 35062): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"harrison_bader_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nHarrison Bader 2025 Splits Data:")
