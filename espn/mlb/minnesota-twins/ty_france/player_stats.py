...
player_name_slug = "ty-france"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/35591/ty-france"
...
try:
    ...
    print(f"Error fetching stats for Ty France (ID: 35591): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Ty France")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Ty France")
    exit(1)
...
output_file = os.path.join(output_dir, f"ty_france_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
