...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4424862/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Spencer Schwellenbach (ID: 4424862): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"spencer_schwellenbach_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSpencer Schwellenbach 2025 Splits Data:")
