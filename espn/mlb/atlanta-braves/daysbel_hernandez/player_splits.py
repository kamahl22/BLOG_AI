...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4722960/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Daysbel Hernandez (ID: 4722960): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"daysbel_hernandez_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDaysbel Hernandez 2025 Splits Data:")
