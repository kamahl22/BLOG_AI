...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4307825/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Spencer Strider (ID: 4307825): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"spencer_strider_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSpencer Strider 2025 Splits Data:")
