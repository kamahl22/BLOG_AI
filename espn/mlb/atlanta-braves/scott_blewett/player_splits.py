...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33816/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Scott Blewett (ID: 33816): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"scott_blewett_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nScott Blewett 2025 Splits Data:")
