...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40346/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Stuart Fairchild (ID: 40346): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"stuart_fairchild_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nStuart Fairchild 2025 Splits Data:")
