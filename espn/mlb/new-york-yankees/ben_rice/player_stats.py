...
player_name_slug = "ben-rice"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/5016968/ben-rice"
...
try:
    ...
    print(f"Error fetching stats for Ben Rice (ID: 5016968): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Ben Rice")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Ben Rice")
    exit(1)
...
output_file = os.path.join(output_dir, f"ben_rice_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
