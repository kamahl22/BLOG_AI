...
player_name_slug = "max-fried"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/32685/max-fried"
...
try:
    ...
    print(f"Error fetching stats for Max Fried (ID: 32685): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Max Fried")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Max Fried")
    exit(1)
...
output_file = os.path.join(output_dir, f"max_fried_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
