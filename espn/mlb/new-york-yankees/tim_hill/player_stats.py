...
player_name_slug = "tim-hill"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/37005/tim-hill"
...
try:
    ...
    print(f"Error fetching stats for Tim Hill (ID: 37005): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Tim Hill")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Tim Hill")
    exit(1)
...
output_file = os.path.join(output_dir, f"tim_hill_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
