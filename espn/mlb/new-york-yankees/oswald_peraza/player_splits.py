...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42479/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Oswald Peraza (ID: 42479): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"oswald_peraza_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nOswald Peraza 2025 Splits Data:")
