...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36202/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Mark Leiter Jr. (ID: 36202): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"mark_leiter_jr_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nMark Leiter Jr. 2025 Splits Data:")
