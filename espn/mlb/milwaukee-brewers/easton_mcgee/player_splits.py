...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41810/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Easton McGee (ID: 41810): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"easton_mcgee_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
