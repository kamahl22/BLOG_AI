...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/5007615/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Caleb Durbin (ID: 5007615): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"caleb_durbin_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
