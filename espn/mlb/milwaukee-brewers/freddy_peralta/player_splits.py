...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39825/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Freddy Peralta (ID: 39825): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"freddy_peralta_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nFreddy Peralta 2025 Splits Data:")
