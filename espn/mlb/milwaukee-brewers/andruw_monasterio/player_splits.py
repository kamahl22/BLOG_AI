...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36950/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Andruw Monasterio (ID: 36950): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"andruw_monasterio_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAndruw Monasterio 2025 Splits Data:")
