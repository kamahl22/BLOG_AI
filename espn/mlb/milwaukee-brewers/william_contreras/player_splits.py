...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39895/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for William Contreras (ID: 39895): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"william_contreras_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nWilliam Contreras 2025 Splits Data:")
