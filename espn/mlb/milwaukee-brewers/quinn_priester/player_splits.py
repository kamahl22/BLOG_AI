...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42449/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Quinn Priester (ID: 42449): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"quinn_priester_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nQuinn Priester 2025 Splits Data:")
