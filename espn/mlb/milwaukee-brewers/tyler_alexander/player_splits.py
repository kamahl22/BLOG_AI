...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40360/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Tyler Alexander (ID: 40360): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"tyler_alexander_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTyler Alexander 2025 Splits Data:")
