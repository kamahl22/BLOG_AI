...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40080/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Trevor Megill (ID: 40080): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"trevor_megill_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTrevor Megill 2025 Splits Data:")
