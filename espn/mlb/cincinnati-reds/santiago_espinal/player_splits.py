...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39924/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Santiago Espinal (ID: 39924): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"santiago_espinal_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nSantiago Espinal 2025 Splits Data:")
