...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33671/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Taylor Rogers (ID: 33671): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"taylor_rogers_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTaylor Rogers 2025 Splits Data:")
