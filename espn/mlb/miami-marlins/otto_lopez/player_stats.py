...
player_name_slug = "otto-lopez"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/41917/otto-lopez"
...
try:
    ...
    print(f"Error fetching stats for Otto Lopez (ID: 41917): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Otto Lopez")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Otto Lopez")
    exit(1)
...
output_file = os.path.join(output_dir, f"otto_lopez_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
