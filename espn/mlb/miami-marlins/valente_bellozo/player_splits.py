...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/5216700/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Valente Bellozo (ID: 5216700): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"valente_bellozo_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nValente Bellozo 2025 Splits Data:")
