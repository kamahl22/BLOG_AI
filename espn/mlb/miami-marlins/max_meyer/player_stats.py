...
player_name_slug = "max-meyer"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/4345164/max-meyer"
...
try:
    ...
    print(f"Error fetching stats for Max Meyer (ID: 4345164): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Max Meyer")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Max Meyer")
    exit(1)
...
output_file = os.path.join(output_dir, f"max_meyer_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
