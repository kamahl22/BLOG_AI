...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39875/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Cal Quantrill (ID: 39875): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"cal_quantrill_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nCal Quantrill 2025 Splits Data:")
