...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/5073992/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"javier_sanoja_gamelog.csv")
if csv_data:
