...
player_name_slug = "derek-hill"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/33721/derek-hill"
...
try:
    ...
    print(f"Error fetching stats for Derek Hill (ID: 33721): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Derek Hill")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Derek Hill")
    exit(1)
...
output_file = os.path.join(output_dir, f"derek_hill_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
