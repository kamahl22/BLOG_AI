...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/31173/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Tucker Barnhart (ID: 31173): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"tucker_barnhart_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTucker Barnhart 2025 Splits Data:")
