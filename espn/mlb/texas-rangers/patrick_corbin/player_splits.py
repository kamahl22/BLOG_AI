...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/31313/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Patrick Corbin (ID: 31313): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"patrick_corbin_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nPatrick Corbin 2025 Splits Data:")
