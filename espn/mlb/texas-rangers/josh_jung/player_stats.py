...
player_name_slug = "josh-jung"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/42437/josh-jung"
...
try:
    ...
    print(f"Error fetching stats for Josh Jung (ID: 42437): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Josh Jung")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Josh Jung")
    exit(1)
...
output_file = os.path.join(output_dir, f"josh_jung_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
