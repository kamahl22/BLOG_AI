...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33499/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Shawn Armstrong (ID: 33499): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"shawn_armstrong_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nShawn Armstrong 2025 Splits Data:")
