...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32146/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Marcus Semien (ID: 32146): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"marcus_semien_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nMarcus Semien 2025 Splits Data:")
