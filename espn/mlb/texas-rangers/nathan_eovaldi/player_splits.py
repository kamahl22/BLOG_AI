...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/31174/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Nathan Eovaldi (ID: 31174): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"nathan_eovaldi_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nNathan Eovaldi 2025 Splits Data:")
