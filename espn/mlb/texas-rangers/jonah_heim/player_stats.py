...
player_name_slug = "jonah-heim"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/33842/jonah-heim"
...
try:
    ...
    print(f"Error fetching stats for Jonah Heim (ID: 33842): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Jonah Heim")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Jonah Heim")
    exit(1)
...
output_file = os.path.join(output_dir, f"jonah_heim_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
