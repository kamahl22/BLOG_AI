...
player_name_slug = "josh-smith"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/42884/josh-smith"
...
try:
    ...
    print(f"Error fetching stats for Josh Smith (ID: 42884): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Josh Smith")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Josh Smith")
    exit(1)
...
output_file = os.path.join(output_dir, f"josh_smith_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
