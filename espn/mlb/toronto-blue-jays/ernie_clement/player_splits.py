...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41287/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Ernie Clement (ID: 41287): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"ernie_clement_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nErnie Clement 2025 Splits Data:")
