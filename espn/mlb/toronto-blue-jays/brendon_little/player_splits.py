...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/39645/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Brendon Little (ID: 39645): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"brendon_little_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nBrendon Little 2025 Splits Data:")
