...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40963/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Daulton Varsho (ID: 40963): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"daulton_varsho_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nDaulton Varsho 2025 Splits Data:")
