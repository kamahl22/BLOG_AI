...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/42081/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Alejandro Kirk (ID: 42081): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"alejandro_kirk_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAlejandro Kirk 2025 Splits Data:")
