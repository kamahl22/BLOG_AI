...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33142/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Tyler Heineman (ID: 33142): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"tyler_heineman_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTyler Heineman 2025 Splits Data:")
