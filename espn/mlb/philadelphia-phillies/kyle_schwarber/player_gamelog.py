...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/33712/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"kyle_schwarber_gamelog.csv")
if csv_data:
