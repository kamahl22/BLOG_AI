...
player_name_slug = "carlos-hernandez"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/41233/carlos-hernandez"
...
try:
    ...
    print(f"Error fetching stats for Carlos Hernandez (ID: 41233): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Carlos Hernandez")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Carlos Hernandez")
    exit(1)
...
output_file = os.path.join(output_dir, f"carlos_hernandez_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nCarlos Hernandez 2025 Stats Data:")
