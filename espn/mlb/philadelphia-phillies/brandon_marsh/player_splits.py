...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/40803/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Brandon Marsh (ID: 40803): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"brandon_marsh_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nBrandon Marsh 2025 Splits Data:")
