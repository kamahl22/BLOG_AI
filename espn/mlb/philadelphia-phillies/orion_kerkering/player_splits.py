...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4630789/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Orion Kerkering (ID: 4630789): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"orion_kerkering_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nOrion Kerkering 2025 Splits Data:")
