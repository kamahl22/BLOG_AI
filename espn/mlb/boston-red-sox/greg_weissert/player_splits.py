...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41485/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Greg Weissert (ID: 41485): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"greg_weissert_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nGreg Weissert 2025 Splits Data:")
