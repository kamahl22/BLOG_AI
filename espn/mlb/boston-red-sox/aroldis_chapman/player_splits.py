...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/30442/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Aroldis Chapman (ID: 30442): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"aroldis_chapman_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nAroldis Chapman 2025 Splits Data:")
