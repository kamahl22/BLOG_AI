...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/35876/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Brennan Bernardino (ID: 35876): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"brennan_bernardino_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nBrennan Bernardino 2025 Splits Data:")
