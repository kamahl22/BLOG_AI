...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/4415836/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Hunter Dobbins (ID: 4415836): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"hunter_dobbins_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nHunter Dobbins 2025 Splits Data:")
