...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/5138677/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"christian_montes_de_oca_gamelog.csv")
if csv_data:
