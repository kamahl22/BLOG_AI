...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41355/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Geraldo Perdomo (ID: 41355): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"geraldo_perdomo_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nGeraldo Perdomo 2025 Splits Data:")
