...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/30738/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Shelby Miller (ID: 30738): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"shelby_miller_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nShelby Miller 2025 Splits Data:")
