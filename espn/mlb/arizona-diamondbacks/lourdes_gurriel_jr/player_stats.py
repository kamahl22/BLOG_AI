...
player_name_slug = "lourdes-gurriel-jr"

# URL for stats
url = f"https://www.espn.com/mlb/player/stats/_/id/36040/lourdes-gurriel-jr"
...
try:
    ...
    print(f"Error fetching stats for Lourdes Gurriel Jr. (ID: 36040): {e}")
    exit(1)
...
if not tables:
    print(f"No stats tables found for Lourdes Gurriel Jr.")
    exit(1)
...
if df.empty:
    print(f"No stats data found for Lourdes Gurriel Jr.")
    exit(1)
...
output_file = os.path.join(output_dir, f"lourdes_gurriel_jr_stats_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nLourdes Gurriel Jr. 2025 Stats Data:")
