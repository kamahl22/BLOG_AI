...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/30627/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Wilmer Flores (ID: 30627): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"wilmer_flores_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nWilmer Flores 2025 Splits Data:")
