...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/43030/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Tyler Fitzgerald (ID: 43030): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"tyler_fitzgerald_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nTyler Fitzgerald 2025 Splits Data:")
