...
# API URL
url = f"https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/6341/gamelog?season={season}"
...
# Write to CSV
output_file = os.path.join(output_dir, f"justin_verlander_gamelog.csv")
if csv_data:
