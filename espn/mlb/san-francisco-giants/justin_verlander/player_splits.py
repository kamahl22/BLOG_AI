...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/6341/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Justin Verlander (ID: 6341): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"justin_verlander_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nJustin Verlander 2025 Splits Data:")
