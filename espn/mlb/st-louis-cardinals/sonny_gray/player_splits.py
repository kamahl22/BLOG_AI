...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32082/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Sonny Gray (ID: 32082): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"sonny_gray_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
