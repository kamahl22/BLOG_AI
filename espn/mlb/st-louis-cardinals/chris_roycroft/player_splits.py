...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/5201199/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Chris Roycroft (ID: 5201199): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"chris_roycroft_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nChris Roycroft 2025 Splits Data:")
