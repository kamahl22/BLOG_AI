...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/32532/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Willson Contreras (ID: 32532): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"willson_contreras_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nWillson Contreras 2025 Splits Data:")
