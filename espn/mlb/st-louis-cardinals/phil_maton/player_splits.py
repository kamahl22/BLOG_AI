...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/36161/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Phil Maton (ID: 36161): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"phil_maton_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
