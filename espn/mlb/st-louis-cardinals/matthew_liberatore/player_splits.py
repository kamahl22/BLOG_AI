...
url = "https://site.web.api.espn.com/apis/common/v3/sports/baseball/mlb/athletes/41173/splits?season=2025"
...
try:
    ...
    print(f"Error fetching data for Matthew Liberatore (ID: 41173): {e}")
    exit(1)
...
output_file = os.path.join(output_dir, f"matthew_liberatore_splits_2025_{datetime.now().strftime('%Y%m%d')}.csv")
...
print(f"\nMatthew Liberatore 2025 Splits Data:")
