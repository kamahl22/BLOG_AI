...
def fetch_and_save_gamelog():
    """Fetch and save the player's game log for the 2025 season."""
    ...
    for table in tables:
        ...
        for row in rows:
            ...
            # Insert a space between the W/L/T and the score, only if it starts with a letter
            ...
            game_row = [date, opponent, result] + stats[:16]  # Cap at expected stats
    ...
    # Save to CSV
    base_dir = "/Users/kamahl/BLOG_AI/database/espn/mlb/teams/chicago_cubs/player/player/seiya_suzuki"
    player_folder = os.path.join(base_dir, "chicago-cubs", "seiya_suzuki")
    os.makedirs(player_folder, exist_ok=True)
    csv_filename = os.path.join(player_folder, "seiya_suzuki_gamelog.csv")
